 ...
 * generated in the mvc.model.webService package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetPersons_QNAME = new QName("http://webService.model.mvc/", "getPersons");
    private final static QName _GetPersonsResponse_QNAME = new QName("http://webService.model.mvc/", "getPersonsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: mvc.model.webService
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://webService.model.mvc/", name = "getPersons")
     ...
     */
    @XmlElementDecl(namespace = "http://webService.model.mvc/", name = "getPersonsResponse")
